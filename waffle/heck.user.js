...
(async function ()  {
    ...
    var scripttoinsert = "async function dohacks() {var yeee = JSON.parse(localStorage.getItem(\"state\"));yeee.puzzle="+ JSON.stringify(yeee.solution) +";yeee.swapsRemaining = 5;localStorage.setItem(\"state\", JSON.stringify(yeee));location.reload();}"
